...
SET Printer1Name="GRILL"
SET Printer2Name="Deep Fry"
SET Printer3Name="SUSHI"
SET Printer4Name="BAR"
SET Printer5Name="RECEIPT"
SET Printer6Name="PAN FRY"
